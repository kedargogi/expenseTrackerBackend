...
window.addEventListener('DOMContentLoaded', async (e)=>{
    let user = await axios.get('http://13.126.85.16:3000/home', { headers: {"Authorization" : token} })
    ...
    let dailyExpenses = await axios.get('http://13.126.85.16:3000/home/report/getDailyExpenses', { headers: {"Authorization" : token} })
    ...
    let weeklyExpenses = await axios.get('http://13.126.85.16:3000/home/report/getWeeklyExpenses', { headers: {"Authorization" : token} })
    ...
    let monthlyExpenses = await axios.get('http://13.126.85.16:3000/home/report/getMonthlyExpenses', { headers: {"Authorization" : token} }) 
...
downloadBtn.addEventListener('click', (e)=>{
    e.preventDefault()
    axios.get('http://13.126.85.16:3000/home/report/download',  { headers: {"Authorization" : token} })
    .then(res=>{
